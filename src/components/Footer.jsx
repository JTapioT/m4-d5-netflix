    ...
    <div className="container">
      <div className="row">
        <div className="col-8 col-8 offset-2">
          <a><img src={"../assets/facebook-square-brands.svg"} className="footer-icon" alt="footer-link-icon" width="25" height="25"/></a>
          <a><img src={"../assets/instagram-square-brands.svg"} className="footer-icon" alt="footer-link-icon" width="25" height="25"/></a>
          <a> <img src={"../assets/twitter-brands.svg"} className="footer-icon"   alt="footer-link-icon" width="25" height="25"/></a>
          <a> <img src={"../assets/youtube-brands.svg"} className="footer-icon"   alt="footer-link-icon" width="25" height="25"/></a>
        </div>
      ...
      <a href="#" className="col-8 offset-2 footer-btn">Service Code</a>
